---
title: Maix Cube USB driver installation
keywords: maixpy, k210, AIOT, edge computing
desc: maixpy ​​doc: Maix Cube USB driver installation
---
...
The development board uses `CH552` to simulate `FT2232`, `Windows` users need to install the driver of `FT2232`.
